            ...
            if missing_inputs:
                ...
                if drop_free_text:
                    ...
                    for key in ("user_id", "tenant_id", "userid"):
                        value = full_context.get(key) or inputs.get(key)
                ...
                # Merge resolved fields with original inputs so required values aren't dropped.
                completed_inputs = {**inputs, **completed_inputs}
